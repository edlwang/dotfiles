return {
	{ -- LSP Configuration & Plugins
		...
		dependencies = {
			...
			-- (Replaces neodev.nvim, which is EOL on Neovim >= 0.10.)
		...
		config = function()
			...
			-- Neovim merges this on top of `make_client_capabilities()` itself when a
			-- client starts (see vim/lsp/client.lua), so we only pass the cmp additions.
